    ...
    <Wrapper>
        ...
        <div>
          {categoryOnlyData.map((currElem, index) => {
            return (
              ...
              className={category === currElem.toLowerCase() ? "active" : null}
              >
                {currElem}
              </button>
            );
      ...
      <div className="filter-color">
        ...
        <div className="filter-color-style">
          {
            colorsOnlyData.map((currElem, index) => {
              if(currElem === "all"){
                return(
                  <button
                  key={index}
...
const Wrapper = styled.section`
  ...
  .filter-clear .btn {
    background-color: #ec7063; // light red orange 
    // background-color: #6254F3; // purple
